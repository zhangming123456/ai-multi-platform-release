<template>
  ...
  >
      ...
      <div class="flex items-center gap-4 shrink-0">
        ...
        <template v-if="!selectedRole?.is_super_admin">
          ...
          <div
            ...
            class="flex items-center gap-3 pl-3 border-l border-black/[0.06]"
          >
            <a-checkbox
    ...
    <div class="p-4">
      ...
      <div v-else class="text-[12px] text-[#86868B] py-2">该资源暂无配置权限项</div>
    </div>
...
const resourcePerms = computed(() => {
  return props.permissions.filter((p) => p.resource.id === props.resource.id && p.is_active)
})
