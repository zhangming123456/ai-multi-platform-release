<template>
  <div class="holiday-source-manager">
    <div class="manager-toolbar">
      <div class="manager-hint">
        启用多个订阅源后，仪表盘日历会合并展示所有已启用来源的事件；同一日期来自多个来源的名称会合并标注（如
        「国庆节 / 秋分」）。自动刷新支持：手动、每小时、每天、每周、每月、每年。
      </div>
      <a-space :size="8" class="manager-actions">
        ...
        <div class="source-row">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="source-guide">
              ...
              <span>；Google 日历可在「设置与共享」中导出 ICS 私密地址</span>
            </div>
          </div>
        </div>
...
} from '@/pages/HolidaySources.types'
