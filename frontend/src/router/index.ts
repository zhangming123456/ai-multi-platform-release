      ...
      children: [
        {
          ...
          meta: { title: '仪表盘', permKey: 'dashboard:read', sidebarType: 'top', sidebarOrder: 0, icon: 'home' },
        },
        {
          path: '403',
          name: 'Forbidden',
        ...
        },
        {
          ...
          meta: { title: '平台管理', permKey: 'platforms:read', sidebarType: 'platforms', sidebarOrder: 0, icon: 'apps' },
        },
        {
          path: 'content',
          name: 'ContentList',
          component: () => import('@/pages/ContentList.vue'),
          meta: { title: '内容列表', permKey: 'content:read', sidebarType: 'content', sidebarOrder: 0, icon: 'file' },
        },
        {
          path: 'content/create',
          name: 'ContentCreate',
          component: () => import('@/pages/ContentCreate.vue'),
          meta: { title: '创作内容', permKey: 'content:read', sidebarType: 'content', sidebarOrder: 1, icon: 'file' },
        },
        {
          path: 'publish',
          name: 'Publish',
          component: () => import('@/pages/Publish.vue'),
          meta: { title: '发布管理', permKey: 'publish:read', sidebarType: 'content', sidebarOrder: 2, icon: 'send' },
        },
        {
          path: 'review',
          name: 'Review',
          component: () => import('@/pages/Review.vue'),
          meta: { title: '内容审核', permKey: 'review:read', sidebarType: 'review', sidebarOrder: 0, icon: 'check' },
        },
        {
          path: 'sql-review',
          name: 'SqlReview',
          component: () => import('@/pages/SqlReview.vue'),
          meta: { title: 'SQL审核', permKey: 'sql_review:read', sidebarType: 'review', sidebarOrder: 1, icon: 'storage' },
        },
        {
          path: 'templates',
          name: 'Templates',
          component: () => import('@/pages/Templates.vue'),
          meta: { title: '模板管理', permKey: 'templates:read', sidebarType: 'content', sidebarOrder: 3, icon: 'apps' },
        },
        {
          path: 'settings/token-plan',
          name: 'TokenPlan',
          component: () => import('@/pages/TokenPlan.vue'),
          meta: { title: 'Token方案', permKey: 'token_plan:read', sidebarType: 'system', sidebarOrder: 0, icon: 'settings' },
        },
        {
          path: 'developer/docs',
          name: 'ApiDocs',
          component: () => import('@/pages/ApiDocs.vue'),
          meta: { title: 'API文档', permKey: 'api_docs:read', sidebarType: 'system', sidebarOrder: 1, icon: 'code' },
        },
        {
          path: 'developer/database',
          name: 'DatabaseConsole',
          component: () => import('@/pages/DatabaseConsole.vue'),
          meta: { title: '数据库控制台', permKey: 'db:read', sidebarType: 'system', sidebarOrder: 2, icon: 'storage' },
        },
        {
          path: 'settings/user-creation-review',
          name: 'UserCreationReview',
          component: () => import('@/pages/UserCreationReview.vue'),
          meta: { title: '用户注册审核', permKey: 'review:read', sidebarType: 'review', sidebarOrder: 2, icon: 'user' },
        },
        {
          path: 'rbac/users',
          name: 'RBACUserManage',
          component: () => import('@/pages/RBACUserManage.vue'),
          meta: { title: '用户管理', permKey: 'users:read', sidebarType: 'rbac', sidebarOrder: 0, icon: 'safe' },
        },
        {
        ...
        },
        {
          ...
          meta: { title: '角色管理', permKey: 'roles:read', sidebarType: 'rbac', sidebarOrder: 1, icon: 'user' },
        },
        {
          path: 'rbac/permissions',
          name: 'RBACPermissionManage',
          component: () => import('@/pages/RBACPermissionManage.vue'),
          meta: { title: '权限管理', permKey: 'permissions:read', sidebarType: 'rbac', sidebarOrder: 2, icon: 'safe' },
        },
        {
          path: 'rbac/permissions/enum',
          name: 'RBACPermissionEnumManage',
          component: () => import('@/pages/RBACPermissionEnumManage.vue'),
          meta: { title: '权限字典管理', permKey: 'permissions:manage:read', sidebarType: 'rbac', sidebarOrder: 3, icon: 'edit' },
        },
        {
        ...
        },
        {
          ...
          meta: { title: '约束管理', permKey: 'constraints:read', sidebarType: 'rbac', sidebarOrder: 4, icon: 'safe' },
        },
      ],
    },
  ],
